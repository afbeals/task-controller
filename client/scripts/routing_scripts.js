...
TCommander.config(function($routeProvider, $locationProvider){
	...
	.when('/Register', {templateUrl: 'partials/registration.html', controller: 'nav_controller', caseInsensitiveMatch: true})
	.when('/Login',{templateUrl: 'partials/login.html', controller: 'nav_controller', caseInsensitiveMatch: true})
